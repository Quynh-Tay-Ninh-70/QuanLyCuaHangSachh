...
public class SachBUS {
    static ArrayList<SachPOJO> listSach;

    public static void setListSach(ArrayList<SachPOJO> listSach) {
        SachBUS.listSach = listSach;
    }

    public static ArrayList<SachPOJO> getListSach() {
        return listSach;
    }
    public  void setlistSach(ArrayList<SachPOJO> listSach) {
        SachBUS.listSach = listSach;
    }

    public  ArrayList<SachPOJO> getlistSach() {
        return listSach;
    }
    public SachBUS() {
    }
    public void  loadDSSach() throws Exception{
        ...
        if(listSach==null) listSach = new ArrayList<SachPOJO>();
        listSach=data.loadDatabase();
    }
    public void addSach(SachPOJO sach) throws Exception{
        // validate data
        SachDAO data =new SachDAO();
        data.addSach(sach);
        listSach.add(sach);
    ...
    public void updateSach(SachPOJO sach) throws Exception{
   ...
   public SachPOJO searchMaSach (String masach)
    {
        for(SachPOJO s : listSach)
        {
    ...
    public ArrayList<SachPOJO> searchSach(String masach,String manxb,String matg,String matl,String tensach,int namxbmin,int namxbmax,float min,float max)
    {
        ArrayList<SachPOJO> search = new ArrayList<>();
