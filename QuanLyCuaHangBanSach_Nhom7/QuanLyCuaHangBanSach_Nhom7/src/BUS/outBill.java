...
public class outBill {
    ...
    private ArrayList<ChiTietHoaDonPOJO> cthd = new ArrayList<ChiTietHoaDonPOJO>();
    private HoaDonPOJO hd;
    private BaseFont bf;
    public outBill()
    {
    ...
    public outBill(HoaDonPOJO hd,ArrayList<ChiTietHoaDonPOJO> cthd) 
    {
        this.hd = hd;
