...
public class outBillNhapHang {
    ...
    private ArrayList<ChiTietPhieuNhapPOJO> cthd = new ArrayList<ChiTietPhieuNhapPOJO>();
    private PhieuNhapPOJO hd;
    private BaseFont bf;
    ...
    public outBillNhapHang(PhieuNhapPOJO hd,ArrayList<ChiTietPhieuNhapPOJO> cthd) 
    {
        this.hd = hd;
    ...
    public void print()
    {
        ...
        try {
            ...
            for(ChiTietPhieuNhapPOJO ct : cthd)
            {
