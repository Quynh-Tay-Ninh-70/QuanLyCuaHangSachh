...
public class ChuongTrinhGiamGiaDAO {
    ...
    public ArrayList<ChuongTrinhGiamGiaPOJO> docDSCT(){
        ArrayList<ChuongTrinhGiamGiaPOJO> dsCT = new ArrayList<>();
        try{
            String sql = "select * from chuongtrinhgiamgia";
            ResultSet rs = conn.executeQuery(sql);
            while(rs.next()){
                ChuongTrinhGiamGiaPOJO cTrinh = new ChuongTrinhGiamGiaPOJO(
                        rs.getString(1), 
                        rs.getString(2), 
                        rs.getString(3), 
                        rs.getString(4), 
