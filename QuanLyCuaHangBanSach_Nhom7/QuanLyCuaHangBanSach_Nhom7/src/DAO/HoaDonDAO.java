...
public class HoaDonDAO {
       private SQLServerConnect MySQL=new SQLServerConnect("localhost","sa","12","bookstore");
       public HoaDonDAO(){}
       public ArrayList<HoaDonPOJO> List(){
       ...
       public void Sua(HoaDonPOJO hd){
           
           try {
           SQLServerConnect MySQL=new SQLServerConnect("localhost","sa","12","bookstore");
     ...
     public static void main(String []args){
           SQLServerConnect c=new SQLServerConnect("localhost","sa","12","bookstore");
