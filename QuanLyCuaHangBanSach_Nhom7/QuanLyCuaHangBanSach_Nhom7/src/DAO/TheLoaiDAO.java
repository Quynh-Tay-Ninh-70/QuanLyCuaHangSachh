...
public class TheLoaiDAO {
    ...
    public TheLoaiDAO() throws IOException {
     ...
     public ArrayList<TheLoaiPOJO> loadDatabase() throws Exception
    {
        ArrayList<TheLoaiPOJO> dstheloai = new ArrayList<>();
        try {
            ResultSet rs = connect.Select("theloai");
            while(rs.next())
            {
                TheLoaiPOJO tl = new  TheLoaiPOJO(rs.getString("MaTL"),rs.getString("TenTL"));     
                dstheloai.add(tl);
            }
     ...
     public void addNXB(TheLoaiPOJO tl) throws Exception
    {
