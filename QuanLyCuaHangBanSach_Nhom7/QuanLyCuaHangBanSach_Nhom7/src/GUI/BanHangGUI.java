...
public class BanHangGUI extends javax.swing.JPanel {
    ...
    private ArrayList<ChiTietHoaDonPOJO> DSCT=new ArrayList<>();
    public BanHangGUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btMaNV.setBackground(new java.awt.Color(51, 255, 0));
        ...
        btMaKH.setBackground(new java.awt.Color(51, 255, 0));
        ...
        btTaoHD.setBackground(new java.awt.Color(255, 51, 51));
        btTaoHD.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        btTaoHD.setForeground(new java.awt.Color(255, 255, 255));
        btTaoHD.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icons8_dossier_folder_30px.png"))); // NOI18N
        ...
        btMaSach.setBackground(new java.awt.Color(51, 255, 0));
        ...
        btThem.setBackground(new java.awt.Color(102, 102, 255));
        btThem.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        btThem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/blue-add-button-12025.png"))); // NOI18N
        btThem.setText("THÊM");
        ...
        btXacNhan.setBackground(new java.awt.Color(255, 204, 0));
        btXacNhan.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        btXacNhan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/check-symbol-4794.png"))); // NOI18N
        ...
        btHuy.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icons8_cancel_30px_1.png"))); // NOI18N
        btHuy.setText("HỦY");
        ...
        btSua.setBackground(new java.awt.Color(255, 153, 153));
        btSua.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        btSua.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/tool-10227.png"))); // NOI18N
        btSua.setText("SỬA");
        ...
        btXoa.setBackground(new java.awt.Color(0, 204, 255));
        btXoa.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        btXoa.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/red-close-circle-20545.png"))); // NOI18N
        btXoa.setText("XÓA");
        ...
        panelCTHDLayout.setHorizontalGroup(
            panelCTHDLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(panelCTHDLayout.createSequentialGroup()
                                ...
                                .addGroup(panelCTHDLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelCTHDLayout.createSequentialGroup()
                                        ...
                                        .addGap(97, 97, 97))
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelCTHDLayout.createSequentialGroup()
                                        .addComponent(btHuy, javax.swing.GroupLayout.PREFERRED_SIZE, 141, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(137, 137, 137))))))
                    .addGroup(panelCTHDLayout.createSequentialGroup()
                        .addGap(33, 33, 33)
                        .addComponent(btThem, javax.swing.GroupLayout.PREFERRED_SIZE, 167, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(73, 73, 73)
                ...
                .addGroup(panelCTHDLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(panelCTHDLayout.createSequentialGroup()
                        ...
                        .addGroup(panelCTHDLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(btSua, javax.swing.GroupLayout.PREFERRED_SIZE, 49, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        btMaGG.setBackground(new java.awt.Color(51, 255, 0));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(panelCTHD, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(75, 75, 75)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(2, 2, 2)
                        .addComponent(btTaoHD, javax.swing.GroupLayout.PREFERRED_SIZE, 46, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel5)
    ...
    private void txMaSachKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txMaSachKeyPressed
       ...
       ArrayList<SachPOJO> sa=new ArrayList<>();
...
//bt Tạo hóa đơn*******************************************************************
    public void TaoHD(){
        ...
        ArrayList<NhanVienPOJO> nvDTO=new ArrayList<>();
        ...
        ArrayList<KhachHangPOJO> khDTO=new ArrayList<>();
...
//clear HĐ CTHĐ
 ...
 //Xuất model ra table
    public void outModel(DefaultTableModel model,ArrayList<ChiTietHoaDonPOJO> dsct){
        Vector row;
        model.setRowCount(0);
        for(ChiTietHoaDonPOJO ct: dsct){
            row=new Vector();
    ...
    public void Them(){
        ...
        if(txMaGG.getText().equals("")){
         giamgia=0;
            ...
            ArrayList<ChiTietChuongTrinhGiamGiaPOJO> ct=new ArrayList<>();
            ct=ctct.dsChiTiet;
            for(ChiTietChuongTrinhGiamGiaPOJO a:ct){
        ...
        if(flag){
            ...
            DSCT.add(new ChiTietHoaDonPOJO(txMaHD.getText(),txMaSach.getText(),txTenSach.getText(),s,gia,giamgia,thanhtien));
        }
        outModel(model,DSCT);
         ...
         for(ChiTietHoaDonPOJO ct : DSCT)
                {
                    if(ct.getMaSach().equals(masp))
                    {
                        ...
                        if(txMaGG.getText().equals("")){
                          ...
                          ChiTietChuongTrinhGiamGiaBUS ctct=new ChiTietChuongTrinhGiamGiaBUS();
                          if(ctct.dsChiTiet==null) ctct.docDSCTGG(txMaGG.getText());
                          ArrayList<ChiTietChuongTrinhGiamGiaPOJO> ct1=new ArrayList<>();
                          ct1=ctct.dsChiTiet;
                          for(ChiTietChuongTrinhGiamGiaPOJO a:ct1){
                          if(a.getMaSach().equals(txMaSach.getText())){
                                 giam=(float)a.getPercent();
                              }
                          }
...
//bt xác nhận hóa đơn *****************************************************************
    public void XacNhan(){
        ...
        float ThanhTien=Float.parseFloat(txThanhTien.getText());
            HoaDonPOJO hd=new HoaDonPOJO(MaHD,MaKH,MaNV,MaGG,NgayLap,TongTien,GiamGia,ThanhTien);
            hdBUS.Them(hd);
