...
public class CungCapGUI extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btThemTL.setBackground(new java.awt.Color(51, 51, 255));
        btThemTL.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        btSuaTL.setBackground(new java.awt.Color(51, 255, 255));
        btSuaTL.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        btXoaTL.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel7Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(txMaTL, javax.swing.GroupLayout.DEFAULT_SIZE, 90, Short.MAX_VALUE)))
                .addContainerGap())
            .addGroup(jPanel7Layout.createSequentialGroup()
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(btXoaTL, javax.swing.GroupLayout.PREFERRED_SIZE, 57, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(btThemTL, javax.swing.GroupLayout.PREFERRED_SIZE, 57, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        btThemNCC.setBackground(new java.awt.Color(51, 51, 255));
        btThemNCC.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        btSuaNCC.setBackground(new java.awt.Color(51, 255, 255));
        btSuaNCC.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        btXoaNCC.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        btTimKiemNCC.setBackground(new java.awt.Color(51, 51, 255));
        btTimKiemNCC.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        btALLNCC.setBackground(new java.awt.Color(102, 255, 102));
        btALLNCC.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        btThemNXB.setBackground(new java.awt.Color(51, 51, 255));
        btThemNXB.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        btXoaNXB.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        btSuaNXB.setBackground(new java.awt.Color(51, 255, 255));
        btSuaNXB.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        btAllNXB.setBackground(new java.awt.Color(102, 255, 102));
        btAllNXB.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        lbNXB.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        lbNXB.setForeground(new java.awt.Color(255, 51, 51));
        ...
        btTimKiemNXB.setBackground(new java.awt.Color(51, 51, 255));
        btTimKiemNXB.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
      ...
      private void docDSTG(){
        try{
            ...
            if(bus.getListTacGia() == null)
                bus.loadDSTacGia();
            for(TacGiaPOJO TG : bus.getListTacGia()){
    ...
    private void search() throws Exception
    {
            ...
            {
                    NCCPOJO ncc = BNCC.timkiem_MaNCC(txTimKiem.getText());			    			
            ...
            {
                    for(NCCPOJO ncc : BNCC.timkiem_TenNCC(txTimKiem.getText()))
                    {
                            tempncc.addRow(addNCC(ncc));
            ...
            {
                    for(NCCPOJO ncc : BNCC.timkiem_DiaChi(txTimKiem.getText()))
                    {
                            tempncc.addRow(addNCC(ncc));
    ...
    private Vector addNCC(NCCPOJO ncc)
    {
        Vector row=new Vector();
    ...
    private void searchNXB() throws Exception
    {
    		...
    		{
	        	NXBPOJO nxb = BNXB.timkiem_MaNXB(txTimKiemNXB.getText());			    			
	    	...
	    	if(cbTimKiemNXB.getSelectedItem() == "Tên NXB" )
                {
                        for(NXBPOJO nxb : BNXB.timkiem_TenNXB(txTimKiemNXB.getText()))
                        {
                                tempxb.addRow(addNXB(nxb));
	    	...
	    	if(cbTimKiemNXB.getSelectedItem() == "Địa chỉ" )
                {
                        for(NXBPOJO nxb : BNXB.timkiem_DiaChiNXB(txTimKiemNXB.getText()))
                        {
                                tempxb.addRow(addNXB(nxb));
                ...
                {
                        for(NXBPOJO nxb : BNXB.timkiem_SDT(txTimKiemNXB.getText()))
                        {
                                tempxb.addRow(addNXB(nxb));
    ...
    private Vector addNXB(NXBPOJO nxb)
    {
    		Vector row=new Vector();
    ...
    private void btThemTLMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btThemTLMouseClicked
        ...
        TheLoaiPOJO tl=new TheLoaiPOJO(matl,tentl);  
    ...
    private void btSuaTLMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btSuaTLMouseClicked
        ...
        try {
             ...
             TheLoaiPOJO tl=new TheLoaiPOJO(idtheloai,tentheloai);
             TheLoaiBUS bus=new TheLoaiBUS();
 ...
 private void docDSTL(){
        try{
            ...
            if(bus.getListTheLoai() == null)
                bus.loadDSTheLoai();
            for(TheLoaiPOJO tl : bus.getListTheLoai()){
                Vector row = new Vector();
                row.add(tl.getMaTL());
                row.add(tl.getTenTL());
                model.addRow(row);
