...
public class GiamGiaGUI extends javax.swing.JPanel {
    private static SachPOJO ketQuaTimKiem;
    /**
    ...
    public static void setKetQuaTimKiem(SachPOJO sach){
        ketQuaTimKiem = sach;
    }
    ...
    private void docDSCT(){
        ...
        for(ChuongTrinhGiamGiaPOJO cTrinh : bus.dsChuongTrinh){
    ...
    private void initComponents() {
        ...
        btnStartDate = new com.toedter.calendar.JDateChooser();
        jLabel10 = new javax.swing.JLabel();
        btnEndDate = new com.toedter.calendar.JDateChooser();
        ...
        btnStartDate.setDateFormatString("yyyy-MM-dd");

        jLabel10.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel10.setText("NGÀY KẾT THÚC:");

        btnEndDate.setDateFormatString("yyyy-MM-dd");

        btnSearch.setBackground(new java.awt.Color(0, 255, 204));
        btnSearch.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        btnSearch.setForeground(new java.awt.Color(255, 255, 255));
        btnSearch.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/search-2912.png"))); // NOI18N
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(btnStartDate, javax.swing.GroupLayout.PREFERRED_SIZE, 127, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(84, 84, 84)
                .addComponent(jLabel10, javax.swing.GroupLayout.PREFERRED_SIZE, 91, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(btnEndDate, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(31, 31, 31)
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(btnStartDate, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel10, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(btnEndDate, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        btnTatCa.setBackground(new java.awt.Color(102, 255, 102));
        ...
        btnThemChiTiet.setBackground(new java.awt.Color(51, 51, 255));
        btnThemChiTiet.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        btmTimSach.setBackground(new java.awt.Color(51, 255, 0));
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
       DefaultTableModel temp=new DefaultTableModel();
         ArrayList<ChuongTrinhGiamGiaPOJO> search=new ArrayList<>();
         Vector header = new Vector();
        header.add("Mã"); header.add("Tên"); header.add("Loại"); header.add("Ngày BD"); header.add("Ngày KT");
        
        ChuongTrinhGiamGiaBUS bus = new ChuongTrinhGiamGiaBUS();
        Date ngayBD = btnStartDate.getDate();
        Date ngayKT = btnEndDate.getDate();
        
        search=bus.timkiem(ngayBD, ngayKT);
         if(search != null && search.size() > 0) {
           ...
           if (temp.getRowCount()==0)
            ...
            row.add(search.get(i).getTenChuongTrinh());
            row.add(search.get(i).getLoai());
            row.add(search.get(i).sqlNgayBD());
            row.add(search.get(i).sqlNgayKT());
            temp.addRow(row);
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        ChuongTrinhGiamGiaPOJO cTrinh = new ChuongTrinhGiamGiaPOJO(ma, ten, loai, ngayBD, ngayKT);
        System.out.println("ok");
        ChuongTrinhGiamGiaBUS bus = new ChuongTrinhGiamGiaBUS();
        System.out.println("ok");
        bus.them(cTrinh);
    ...
    private void setModelChiTiet(String MaGG){
        ...
        for(ChiTietChuongTrinhGiamGiaPOJO chitiet: bus.dsChiTiet){
            Vector row = new Vector();
    ...
    private void btnThemChiTietActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemChiTietActionPerformed
        ...
        ChiTietChuongTrinhGiamGiaBUS bus = new ChiTietChuongTrinhGiamGiaBUS();
        ChiTietChuongTrinhGiamGiaPOJO ct_cTrinh = new ChiTietChuongTrinhGiamGiaPOJO(MaGG, percent, MaSach);
        bus.them(ct_cTrinh);
    ...
    private com.toedter.calendar.JDateChooser btnEndDate;
    private javax.swing.JButton btnSearch;
    private com.toedter.calendar.JDateChooser btnStartDate;
