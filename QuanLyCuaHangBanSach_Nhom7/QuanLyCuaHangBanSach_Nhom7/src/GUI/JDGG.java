...
// Load DB GG**************************
    public void outModel(DefaultTableModel model,ArrayList<ChuongTrinhGiamGiaPOJO> gg){
        Vector row;
        model.setRowCount(0);
        for(ChuongTrinhGiamGiaPOJO ctgg: gg){
            row=new Vector();
            row.add(ctgg.getId());
    ...
    public void LoadDBGG(){
        ...
        ArrayList<ChuongTrinhGiamGiaPOJO> ct=ctgg.dsChuongTrinh;
        outModel(model,ct);
    }
// lấy mã gg*************************************
    public void Click(){
