...
/*************************************Đọc DSNV*******************************/
    public void outModel(DefaultTableModel model,ArrayList<NhanVienPOJO> nv){
        Vector row;
        model.setRowCount(0);
