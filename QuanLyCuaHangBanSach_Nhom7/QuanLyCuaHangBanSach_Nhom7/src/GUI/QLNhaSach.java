...
public class QLNhaSach extends JFrame implements MouseListener {
    ...
    public void init() throws Exception
    {
        ...
        ImageIcon logo = new ImageIcon("./src/img/SanPham/bookstore-icon-in-flat-style-isolated-on-white-vector-13532862.jpg");
...
/************ PHẦN HEADER *************************************/      
        ...
        if(userName != null)
        {
            ...
            JLabel user = new JLabel("Konichiwa, "+userName);
            user.setFont(font);
...
/************ PHẦN NAVIGATION ( MENU ) **************************/  
        nav = new JPanel(null);
        nav.setBackground(new Color(255,0,255));
        ...
        navItem = new ArrayList<>();  //Chứa thông tin có button cho menu gồm ( Tên btn : icon : icon hover )
            navItem.add("Bán Hàng:store-2017.png:shopping-cart-2029.png");
            navItem.add("Thông Tin Sách:books-13506.png:student-study-5438.png");
            navItem.add("Quản Lý Nhân Viên:teamwork-people-and-lightbulb-18792.png:blue-person-10779.png");
            navItem.add("Quản Lý Khách Hàng:salary-and-employee-18646.png:KhachHang_20px_active.png");
            navItem.add("Nhập & Xuất Sách:NhapHang_20px_active.png:NhapHang_20px_active.png");
            navItem.add("Giảm Giá:discount-3747.png:50-percent-9733.png");
            
        if( role == null || role.equalsIgnoreCase("Admin") )
        {
            navItem.add("Tài Khoản:icons8_key_30px.png:icons8_password_40px.png");
            navItem.add("Thống Kê:ThongKe_20px.png:icons8_bar_chart_30px.png");
            
        }
        navItem.add("Nhà Cung Cấp:icons8_client_company_30px.png:icons8_company_30px.png");
        outNav();
...
/**************************************************************/   
    ...
    public void mouseClicked(java.awt.event.MouseEvent e) {
        for(int i  = 0 ; i<navObj.size();i++)
        {
            ...
            if(e.getSource()== item)
            {
                ...
                try {
                    if(role.compareToIgnoreCase("Admin")==0) changeMainInfo(i); 
                    else changeMainInfoStaff(i);
                } catch (Exception ex) {
    ...
    //              main.add(new Page404(DEFALUT_WIDTH, "THỐNG KÊ - NHẬP HÀNG"));
      ...
      public void changeMainInfoStaff(int i) throws Exception //Đổi Phần hiển thị khi bấm btn trên menu
    {
        if(flag && i>4 && i<9) // Thay đổi nếu Thông kế đang dropdown
        {
            i = i + 2;
    ...
    public void outNav()
    {
        ...
        {
            navObj.get(5).setColorNormal(new Color(255,255,0));
            navObj.get(6).setColorNormal(new Color(255,255,0));
        }
        
        //Xuất ra Naigation
        nav.removeAll();
        JLabel profile = new JLabel(new ImageIcon("./src/img/6911511 .jpg"));
