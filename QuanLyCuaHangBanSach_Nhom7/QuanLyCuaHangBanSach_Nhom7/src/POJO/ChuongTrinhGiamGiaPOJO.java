 ...
 * @author tungk
 */
public class ChuongTrinhGiamGiaPOJO {
    String id;
    ...
    public ChuongTrinhGiamGiaPOJO(String id, String tenChuongTrinh, String Loai, Date NgayBD, Date NgayKT) {
        this.id = id;
    ...
    public ChuongTrinhGiamGiaPOJO(String id, String tenChuongTrinh, String Loai, String NgayBD, String NgayKT) {
        this.id = id;
        this.tenChuongTrinh = tenChuongTrinh;
        this.Loai = Loai;
