...
public class DateCustomPOJO {
   private int day,month,year;
    
    public DateCustomPOJO(){}// to Easy for Scan
    public DateCustomPOJO(int d,int m,int y){
        day=d; 
         month=m;
           year=y;
    }
...
}   public int CompareTo(DateCustomPOJO d2){
...
public static int CompareTo(DateCustomPOJO d1,DateCustomPOJO d2){
