...
public class timKiemKhachHangGUI extends javax.swing.JFrame {
    ...
    private void btnTimKiemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTimKiemActionPerformed
        ...
        switch (comboInput.getSelectedIndex()){
            case 0:
                for(KhachHangPOJO kh : bus.timKiemId(input)){
                ...
                break;
            case 1:
                for(KhachHangPOJO kh : bus.timKiemHo(input)){
                    Vector row = new Vector();
                    row.add(kh.getId());
                    row.add(kh.getHo());
                    row.add(kh.getTen());
                ...
                break;
            case 2:
                for(KhachHangPOJO kh : bus.timKiemTen(input)){
                    Vector row = new Vector();
                    row.add(kh.getId());
                    row.add(kh.getHo());
                    row.add(kh.getTen());
                ...
                break;
            case 3:
                for(KhachHangPOJO kh : bus.timKiemSDT(input)){
                    Vector row = new Vector();
                    row.add(kh.getId());
                    row.add(kh.getHo());
                    row.add(kh.getTen());
                ...
                break;
            case 4:
                for(KhachHangPOJO kh : bus.timKiemEmail(input)){
                    Vector row = new Vector();
                    row.add(kh.getId());
                    row.add(kh.getHo());
                    row.add(kh.getTen());
                ...
                break;
            case 5:
                for(KhachHangPOJO kh : bus.timKiemPhai(radio1.isSelected())){
                    Vector row = new Vector();
                    row.add(kh.getId());
                    row.add(kh.getHo());
                    row.add(kh.getTen());
            ...
            case 6: 
                ...
                for(KhachHangPOJO kh : bus.timKiemTCT(radio1.isSelected(), tct)){
                    Vector row = new Vector();
                    row.add(kh.getId());
                    row.add(kh.getHo());
                    row.add(kh.getTen());
